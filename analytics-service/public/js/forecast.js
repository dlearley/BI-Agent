class ForecastSandbox {
  ...
  initializeEventListeners() {
    ...
    document
      ...
      .addEventListener('click', () => this.generateForecast());
    document.getElementById('saveScenario').addEventListener('click', () => this.saveScenario());
    document
      .getElementById('refreshScenarios')
      .addEventListener('click', () => this.loadScenarios());
  ...
  displayScenarios(scenarios) {
    ...
    if (scenarios.length === 0) {
      scenarioList.innerHTML =
        '<p style="color: #666; font-style: italic;">No scenarios found. Create your first forecast to get started!</p>';
      return;
    }
